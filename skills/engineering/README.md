...
- **[git-declutter](./git-declutter/SKILL.md)** — Lossless cleanup of branches and worktrees: triage on evidence, salvage uncommitted work, consolidate every to-be-deleted branch tip into one archive commit, verify reachability, then remove — nothing recoverable is ever lost.
