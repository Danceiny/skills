...
- **[git-declutter](./skills/engineering/git-declutter/SKILL.md)** — Lossless cleanup of branches and worktrees: archive every to-be-deleted branch tip into one merge commit, verify reachability, then remove — nothing recoverable is ever lost.
